...
<%@ page import="com.ecom.service.impl.*,com.ecom.service.*"%>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #BDE1DE; color: white; padding: 5px;">
<h1 style="color:#345452;">Shopycliq</h1>
		<h6 style="color:#345452;">"The Cliq to Your Perfect Shop"</h6>
