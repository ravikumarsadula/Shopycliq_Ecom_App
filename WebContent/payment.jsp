...
<%@ page
	import="com.ecom.service.impl.*,com.ecom.service.*,com.ecom.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
			...
			<form action="./OrderServlet" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<div class="form-group">
						...
						<h2 style="color: green;">Debit Card Payment</h2>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="last_name">Enter Card Number</label> <input
