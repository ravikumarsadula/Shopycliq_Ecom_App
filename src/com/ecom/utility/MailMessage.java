...
public class MailMessage {
	public static void registrationSuccess(String emailId, String name) {
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				+ "<h2 style='color:green;'>Welcome to Shopycliq</h2>" + "" + "Hi " + name + ","
				+ "<br><br>Thanks for singing up with Shopycliq.<br>"
				+ "We are glad that you choose us. We invite you to check out our latest collection of new electonics appliances."
				+ "<br>We are providing upto 37% OFF on most of the electronic gadgets. So please visit our site and explore the collections."
				...
				+ "to enter the promo code given below.<br><br><br> PROMO CODE: " + "SHOPYCLIQ500<br><br><br>"
				+ "Have a great day!<br>" + "" + "</body>" + "</html>";
		try {
	...
	public static void transactionSuccess(String recipientEmail, String name, String transId, double transAmount) {
		...
		String subject = "Order Placed at Shopycliq";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Shopocliq!" + "      <br/><br/>"
				+ "      Your order has been placed successfully and under process to be shipped, you may expect product delivery within 3 to 4 working days."
				...
				+ "      Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">Shopycliq</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
	...
	public static void orderShipped(String recipientEmail, String name, String transId, double transAmount) {
		String recipient = recipientEmail;
		String subject = "Hurray!!, Your Order has been Shipped from Shopycliq";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Shopycliq!" + "      <br/><br/>"
	...
	public static void productAvailableNow(String recipientEmail, String name, String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product " + prodName + " is Now Available at Shopycliq";
		String htmlTextMessage = "<html>" + "  <body>" + "    <p>" + "      Hey " + name + ",<br/><br/>"
				+ "      We are glad that you shop with Shopycliq!" + "      <br/><br/>"
				...
				+ "      Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">Shopycliq.</font>"
				+ "    </p>" + "    " + "  </body>" + "</html>";
