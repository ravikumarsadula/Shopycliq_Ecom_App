...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "shopycliq@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Snapify</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Shopycliq.<br>"
					+ "We are glad that you choose <bold>us. We invite you to check out our latest collection of new electonics appliances."
					+ "<br>We are providing upto 37% OFF on most of the electronic gadgets. So please visit our site and explore the collections. <br>"
					...
					+ "<span class='greenText'>SHOPYCLIQ500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
